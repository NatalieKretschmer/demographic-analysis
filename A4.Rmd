...
Based on the coefficients, waist circumference does increase with age, but at a decreasing rate.
...
Based on the confidence intervals, the only two periods that show waist circumferences significantly different from one another are 2011-12 and 2017-18. There is an upward trend in the periods between, but with no significant difference in immediately adjacent periods.

```{r cohort plot, echo = F}
...
The cohort effect shows a fluctuation in waist circumference, staring with a downward trend from the 1931-40 cohort to the 1951-60 cohort. There is no significant difference between the 1951-60 and the 1961-70 cohorts. There's an upward trend from 1961-70 to 1990-2000, and a downward trend again between 1990-2000 and 2011-2020.
